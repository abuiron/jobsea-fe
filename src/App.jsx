...
import { ProSidebarProvider } from 'react-pro-sidebar'; // Using fallback
...
// Suppress deprecation warning in the console
console.warn = (...args) => {
    if (args[0].includes('ProSidebarProvider is deprecated')) return;
    console.log(...args);
};
    ...
    return (
        <>
            ...
            <ThemeProvider theme={theme}>
                <CssBaseline />
                <ProSidebarProvider> {/* Using ProSidebarProvider as fallback */}
                    <BrowserRouter>
                        <Routes>
